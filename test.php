                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        echo "<table id='example2' style='text-align:center; background-color:white;' class='table table-bordered table-hover'>" . "<thead><tr><th>" . "Candidate ID" . "</th><th>" . "Full name" . "</th><th>" . "Date of Birth" . "</th><th>" . "Age" . "</th><th>" . "Gender" . "</th><th>" . "Address" . "</th><th>" . "Contact number" . "</th><th>" . "E-mail" . "</th><th>" . "Actions" . "</th></tr></thead>";
